    ...
    startRenderLoop() {
        const render = (currentTime) => {
            ...
            this.networkAnalyzer.update(currentTime);
            this.analyticsManager.update(currentTime);
    ...
    handleResearchCardHover(event) {
        ...
        // Create subtle preview visualization
        this.visualizationEngine.previewCategory(category);
    ...
    handleResearchCardLeave(event) {
        ...
        // Remove preview
        this.visualizationEngine.clearPreview();
